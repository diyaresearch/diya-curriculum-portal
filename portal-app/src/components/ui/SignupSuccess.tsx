export interface SignupSuccessProps {
  /** The new account holder's display name. */
  name: string;
  /** "Teacher" / "Student" - rendered into the confirmation sentence. */
  type: string;
  onLogin: () => void;
}

export default function SignupSuccess({ name, type, onLogin }: SignupSuccessProps) {
  return (
