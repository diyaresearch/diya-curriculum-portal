import { KEYWORD, TEXT_TOKENS, colorName, arb, spaceStep, cssValue, cssName, UNITLESS } from "./map.mjs";
...
/**
 * One CSS declaration -> Tailwind classes, or null when it must stay inline.
 * `emit` collects classes; returning false means "not representable".
 */
